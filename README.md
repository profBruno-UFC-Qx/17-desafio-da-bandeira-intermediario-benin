...
Neste exercício prático, você irá construir a bandeiras do Benin usando CSS.
...
1. Construa a bandeira do Botswana alterando o conteúdo do arquivo **src/index.html** e **src/css/estilo.css**
